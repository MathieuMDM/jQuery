  ...
  if (arg > 0) {
    $("#slides").animate(
      ...
      function () {
        ...
        afterAnim();
        // $("#slides .item").append(itemsAjoute);
        // $("#slides").css("margin-left", "0");
        // afterAnim();
      }
    );
    ...
    // $("#slides").prepand(derniersItems);
    $("#slides").prepend(derniersItems);
    // $("#slides").css("max-left", arg * largeur + "px");
    $("#slides").css("margin-left", arg * largeur + "px");
    $("#slides").animate({ "margin-left": 0 }, datas.prefs.tIMG, afterAnim);
  }
}
...
function afterAnim() {
  ...
  // $("slides .item").first().find("p, button").fadeIn(dates.prefs.tTXT);
